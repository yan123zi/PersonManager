    ...
    <div class="content-wrap">
            <div class="main">
                ...
                <section id="main-content">
                    <div class="row">
                        <div class="" style="width: 1100px;margin-left: 50px">
                            <div class="card">
                                            ...
                                            <tbody>
	                                            <c:forEach items="${employeeList }" var="employee">
	                                                <tr>
	                                                    ...
	                                                    <c:if test="${employee.eIfwork==1 }">
	                                                    	<td>在职</td>
	                                                    </c:if>
	                                                    <c:if test="${employee.eIfwork==2 }">
	                                                    	<td>在职</td>
	                                                    </c:if>
	                                                    <td style="width: 300px;"> 
		                                                    <c:if test="${employee.eIfwork==1 }">
		                                                    	<button up="${employee.eId }" data-toggle="modal" data-target="#up" type="button" class="btn btn-primary btn-outline btn-rounded m-b-10 m-l-5 update">加入人才库</button>
		                                                    	<button del="${employee.eId }" data-toggle="modal" data-target="#delete" type="button" class="btn btn-default btn-outline btn-rounded m-b-10 dismissal">将其解雇</button>
		                                                    </c:if>
		                                                    <c:if test="${employee.eIfwork==2 }">
			                                                    <button type="button" class="btn btn-primary btn-outline btn-rounded m-b-10 m-l-5">同意申请</button>
	                                                    		<button type="button" class="btn btn-default btn-outline btn-rounded m-b-10">拒绝申请</button>
                                                    		</c:if>
	                                                    </td>
	                                                </tr>
	                                             </c:forEach>
                            ...
                            <!-- 添加到人才库 -->
	                        <div class="modal fade" id="up" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
							      <div class="modal-header">
							        <h4 class="modal-title" id="myModalLabel">将该人员加入人才库?</h4>
							        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
							      </div>
							      <div class="modal-body">
							      	<form:form id="update" method="post" action="${pageContext.servletContext.contextPath }/adminPerson/toBeTalent">
							      		<input type="hidden" name="eId" value="1">
									</form:form>
							      </div>
							      <div class="modal-footer">
							        <button type="button" id="pSend" class="btn btn-warning">Determine</button>
	                        ...
	                        <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
							      <div class="modal-header">
							        <h4 class="modal-title" id="myModalLabel">解雇原由发送</h4>
							        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
							      </div>
							      <div class="modal-body">
							      	<form:form id="deleteEmp" method="delete" action="${pageContext.servletContext.contextPath }/adminPerson/dismissEmp">
							      		<input type="hidden" name="eId" value="1">
									  <div class="form-group">
									  	<textarea name="message" id="message" style="width: 440px;height: 200px">Because there are some problems in your work, we will dismiss you.</textarea>
									  </div>
									</form:form>
							      </div>
							      <div class="modal-footer">
							        <button type="button" id="dSend" class="btn btn-primary">Send Message</button>
							        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
							      </div>
							    </div>
							  </div>
    	...
    	$(function(){
    		...
    		*/
    		$(".update").click(function(){
    			$("#update input:eq(0)").val($(this).attr("up"));
    		});
    		...
    		*/
    		$(".dismissal").click(function(){
    			$("#deleteEmp input:eq(1)").val($(this).attr("del"));
    		});
